...
# =============================================================================
# FUNCTIONAL TESTS — add_document() and search()
# =============================================================================
...
class TestAddDocumentAndSearch:
    ...
    def test_search_top_result_is_correct_document(self, kb):
        """An S3-specific query must retrieve a chunk from the S3 seed document."""
        results = kb.search("S3 Block Public Access settings", n_results=1)
        assert len(results) > 0
        top_doc = results[0]["metadata"]["doc_id"]
        assert top_doc == "aws-s3-security", (
            f"Expected aws-s3-security, got {top_doc}"
        )
...
# =============================================================================
# FUNCTIONAL TESTS — delete_document() and list_documents()
# =============================================================================
...
# =============================================================================
# FUNCTIONAL TESTS — build_augmented_prompt()
# =============================================================================
...
# =============================================================================
# FUNCTIONAL TESTS — query_knowledge_base()
# =============================================================================
...
# =============================================================================
# FUNCTIONAL TESTS — handle_rag_tool_call()
# =============================================================================
